...
extension BackendlessManager {
    private static let CATALOG_URL = "https://files.ryanbalieiro.com/pokedex/pokemon.json"
    private static let ASSETS_URL = "https://files.ryanbalieiro.com/pokedex/pokemon.zip"
